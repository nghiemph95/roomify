...
export const getHostedUrl = (
  ...
  // File path đã bao gồm "roomify-hosting/" prefix, nhưng URL cần loại bỏ nó
  // vì hosting subdomain đã point đến "roomify-hosting" directory
  // Ví dụ: filePath = "roomify-hosting/projects/123/source.jpg"
  // → URL = "https://subdomain.puter.site/projects/123/source.jpg"
  const relativePath = filePath.startsWith('roomify-hosting/')
    ? filePath.substring('roomify-hosting/'.length)
    : filePath;
